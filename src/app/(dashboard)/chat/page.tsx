...
const initialMessages = [
  {
    ...
    type: "ai",
    content:
      "مرحباً! أنا مساعدك الذكي لإدارة الجودة. كيف يمكنني مساعدتك اليوم؟",
  ...
  },
  {
    ...
    type: "ai",
    content:
      "بالطبع! لقد قمت بتحليل الاختبارات الـ 247 الأخيرة. معدل النجاح 88.1% وهو تحسن بنسبة 12% عن الشهر الماضي. هل تريد تفاصيل أكثر حول نوع معين من الاختبارات؟",
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      {/* Enhanced Mobile-Responsive Input Area */}
      <motion.div
        className="mobile-nav-spacing border-t border-sidebar-border bg-background safe-area-bottom"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:items-end">
          <div className="flex-1">
            <Input
              ...
              className="min-h-[50px] sm:min-h-[44px] resize-none bg-sidebar-accent/50 border-sidebar-border focus:bg-background text-responsive-sm"
              dir="rtl"
              disabled={isLoading}
              onKeyPress={(e) => {
